<?php
	...
	$mail->Username = 'seu_email@gmail.com'; //usu�rio do smtp (email cadastrado no servidor)
	$mail->Password = 'sua_senha'; //senha ****CUIDADO PARA N�O EXPOR ESSA INFORMA��O NA INTERNET OU NO F�RUM DE D�VIDAS DO CURSO****
